...
\restrict 5lL4nOCiupiVzb5MLiLb93DnpZMGgcoclfLk5VC6PjZ1oaolRna8fR5jFEuSFqY
...
--
-- Name: next_invoice_seq(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.next_invoice_seq() RETURNS integer
...
--
-- Name: next_ticket_seq(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.next_ticket_seq() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  new_seq integer;
...
--
-- Name: quick_items; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: quick_items_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: quick_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: repair_components; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: repair_components_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: repair_components_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: salary_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: salary_config_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.shop_config (
    ...
    ticket_prefix text DEFAULT 'TK'::text,
...
--
-- Name: udhar; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: udhar_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: udhar_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: quick_items id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: repair_components id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: salary_config id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: udhar id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: active_sessions active_sessions_employee_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: quick_items quick_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: repair_components repair_components_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: salary_config salary_config_employee_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: salary_slips salary_slips_employee_id_month_year_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: udhar udhar_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: returns returns_original_sale_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: salary_config salary_config_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sales sales_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: udhar udhar_sale_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employees allow all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: inventory allow all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: returns allow all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: sales allow all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shop_config allow all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: tickets allow all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: udhar allow all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: password_reset_requests anon full access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: active_sessions anon_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: udhar; Type: ROW SECURITY; Schema: public; Owner: -
--
...
\unrestrict 5lL4nOCiupiVzb5MLiLb93DnpZMGgcoclfLk5VC6PjZ1oaolRna8fR5jFEuSFqY
